-- ChoreTracker — combined setup (migrations 0001 + 0002 + 0003, in order)
-- Paste this ENTIRE file into the Supabase SQL editor and Run. Then run seed.sql separately.
