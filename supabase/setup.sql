-- ChoreTracker — combined setup (migrations 0001..0005, in order)
-- Paste this ENTIRE file into the Supabase SQL editor and Run. Then finish-setup.sql for accounts/data.
